...
extern char* PiperSendVoice(int handle, char* peerID, char* filePath, int durationSec);
extern char* PiperSendVoiceToGroup(int handle, char* groupID, char* filePath, int durationSec);
...
extern void PiperKickFromGroup(int handle, char* groupID, char* peerID);
